...
/*
================================================== 
This file is a part of CMSimple 4.8
Released: 2019-10-14
...
<div style="background: #d6d6d0; padding: 1px 12px 3px 12px; margin: 6px 0;">';
				...
				$o .= '
<p>
<a href="?delete_of&delete_of=' . $of . '&securityCode=' . $_SESSION[$csrfSession] . '" title="' . $tx['restore']['delete_file'] . '" onClick="return confirm(\'' . $tx['restore']['confirm_delete_file'] . '\')"><img src="./css/icons/delete.gif" style="margin-bottom: -3px;" alt=""></a>&nbsp; 
...
&nbsp;|&nbsp;<a href="?restore&restore_pf=' . str_ireplace('.php','',$of) . '&restore_cf=' . str_ireplace('pagedata','content',str_ireplace('.php','',$of)) . '&securityCode=' . $_SESSION[$csrfSession] . '" onClick="return confirm(\'' . $tx['restore']['confirm_restore_backup'] . '\')"> <img src="./css/icons/restore.gif" style="margin-bottom: -3px;" alt=""> <b>' . $tx['restore']['restore_backup'] . '</b></a>
</p>';
				}
